...
if __name__ == '__main__':
    aid = '8a216da8757784cd0175961167a90ceb'
    atoken = '38ea721179454e988a52464234f5d338'
    appid = '8a216da8757784cd01759611685d0cf1'
    #模板id
    tid = '1'
    x = YunTongXin(aid,atoken,appid,tid)
    res = x.run('15323766372','886699')
    print(res)